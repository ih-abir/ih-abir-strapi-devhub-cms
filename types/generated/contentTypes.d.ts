...
export interface ApiBasicPageBasicPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Intro_blob: Schema.Attribute.Media<'images'>;
...
export interface ApiGenericElementGenericElement
  ...
  attributes: {
    ...
    Footer_menu: Schema.Attribute.Component<'shared.menu', true> &
      Schema.Attribute.Required;
    Footer_social_media_links: Schema.Attribute.Component<
    ...
    > &
      Schema.Attribute.Private;
    Nav_menu: Schema.Attribute.Component<'shared.menu', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    Nav_social_media_links: Schema.Attribute.Component<
      'shared.social-media-links',
      true
    >;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Block3_title_tag: Schema.Attribute.String;
...
export interface ApiRobotsTextRobotsText extends Struct.SingleTypeSchema {
...
export interface ApiSecurityTextSecurityText extends Struct.SingleTypeSchema {
